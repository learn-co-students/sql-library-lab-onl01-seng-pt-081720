...
def select_character_names_and_number_of_books_they_are_in
  ...
  COUNT(character_books.book_id) as book_count FROM characters
  ...
  # "SELECT characters.name, COUNT(name) as book_count from character_books JOIN characters ON character_books.character_id = characters.id GROUP BY characters.name ORDER BY book_count DESC"
